...
code which I could finish with maximum 250 line of Code and save 5€ by not buying "Crosshair X"
...
4.) I added a tray icon with hide/show button
5.) More options for Crosshair customizations
6.) HUD Frame for Live FPS/CPU/RAM usage Screen in the right top corner
7.) Donation Frame to gain something
8.) Themes button to change the Colors of the Menu.

It works perfectly now beside the FPS/CPU/RAM Screen it is sometimes buggy.
I will fix it soon.
